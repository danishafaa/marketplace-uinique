...
import BuyButton from './BuyButton'; // Pastikan BuyButton sudah diimpor

// Definisikan props (sudah ada)
...
export default async function ProductDetailPage({ params }: ProductDetailPageProps) {
    // Ambil produk dan Store-nya (Logika Fetching)
    ...
    // Format Harga untuk tampilan (Perbaikan Logika)
    ...
    return (
        // ⚠️ INI ADALAH WRAPPER DAN STYLING BARU
