...
const LoginPage = () => {
    // 3. Handler sederhana untuk mencegah error form submission
            ...
            <div className="bg-white w-full max-w-5xl rounded-[40px] shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[550px]">
                ...
                <div className="w-full md:w-1/2 p-12 flex flex-col justify-center items-center text-center space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        {/* 4. Menggunakan Link daripada button kosong untuk navigasi */}
                        <Link href="/register">
                ...
                <div className="w-full md:w-1/2 p-12 flex flex-col justify-center bg-white">
                    <div className="max-w-md mx-auto w-full space-y-6">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <button type="submit" className="w-full bg-[#002d4b] text-white py-4 rounded-xl text-xl font-bold hover:bg-[#00365a] transition-all shadow-md mt-4">
                                LOG IN
                            </button>
                        </form>
